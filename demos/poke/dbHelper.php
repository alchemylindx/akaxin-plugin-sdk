...
class DBHelper
{
    ...
    {
        $conf = getConf();
        $this->dbName = "openzaly_poke_{$conf["db_safe_prefix"]}.db";
    ...
    public function checkDBExists(){
        ...
        " game_result VARCHAR(10) NOT NULL DEFAULT '',".
            ...
            " game_accuracy VARCHAR(10) NOT NULL DEFAULT '',".
     ...
     */
    public function insertGameResult($siteUserId, $siteUserPhoto, $chatSessionId, $gameResult, $gameUseTime, $gameAccuracy)
    {
        try{
            $createTime = date('Y-m-d H:i:s', time());
            $sql = "insert into  `$this->tableName`(site_user_id, site_user_photo, chat_session_id, game_result,game_use_time, game_accuracy, create_time) values(?, ?, ?, ?, ?,?,?)";
            ...
            $prepare->bindParam(6, $gameAccuracy, \PDO::PARAM_STR);
            $prepare->bindParam(7, $createTime, \PDO::PARAM_STR);
