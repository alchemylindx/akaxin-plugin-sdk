...
$conf = [
    "default" => [
        ...
        "plugin_http_domain" => "http://192.168.3.43:5177",
        "plugin_http_domain" => "http://192.168.1.102:5177",
...
//        "site_address" => "192.168.3.43:2022",
        ...
        // PluginApiServer
        "plugin_id" => 4, //plugin id, 请在管理平台 -> 扩展管理 -> 点击对应扩展获取
        "plugin_auth_key" => "Fd24qFhPq7JjX299",
        "plugin_api_host" => "192.168.1.102",    // 对应启动服务器时的 -Dhttp.address 参数
